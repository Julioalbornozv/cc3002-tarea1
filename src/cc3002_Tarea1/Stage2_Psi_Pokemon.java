...
public class Stage2_Psi_Pokemon extends Abs_PsiPokemon implements IBasicPokemon{
	private int prevol;
	
	public Stage2_Psi_Pokemon(int id, String name, int hp, int pre, IAbility ... skills) {
